...
Description: Extends base Carbon fields with {{FIELD_NAME}} field. 
Version: 1.0.0
*/
 ...
 */
add_action('after_setup_theme', 'crb_init_carbon_field_{{FIELD_NAME}}', 15);
function crb_init_carbon_field_{{FIELD_NAME}}() {
	if (class_exists("Carbon_Field")) {
		include_once dirname(__FILE__) . '/Carbon_Field_{{FIELD_NAME}}.php';
	}
}
